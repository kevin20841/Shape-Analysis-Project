...
matrix_elastic = np.loadtxt("matrix_elastic.out")
matrix_kd = np.loadtxt("matrix_kd.out")


matrix_elastic = np.reshape(matrix_elastic, (100, 100))
...
plt.imshow(matrix_kd, cmap='hot', interpolation='nearest')
plt.figure()
plt.imshow(matrix_elastic, cmap='hot', interpolation='nearest')
plt.figure()
plt.imshow(matrix_kd - matrix_elastic, cmap="hot", interpolation="nearest")
plt.show()
