...
def find_gamma(p, q, parametrization_array, neighborhood, strip_height, length_array):
    """
    ...
    i = 0
    while i < length_array[0]:
        temp1[0][i] = tp[parametrization_array[i]]
        temp1[1][i] = py[parametrization_array[i]]
        temp2[0][i] = tq[parametrization_array[i]]
        temp1[1][i] = qy[parametrization_array[i]]
        temp3[0][i] = tg[parametrization_array[i]]
        temp3[1][i] = g[parametrization_array[i]]
        i = i + 1
    ...
    while current_iteration < max_iteration:
        i = 0
        parametrization_size = length_array[current_iteration]
        m = parametrization_size
        n = parametrization_size
        gamma_interval = 1 / (m-1)

        rough_path = parametrization_array[current_iteration]
