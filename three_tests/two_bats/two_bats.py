    ...
    for i in range(len(bat_1)):
        ...
        for shape_rep in shape_reps:
            ...
            uenergy, p1, q1, tg1, gamma1 = shapedist.find_shapedist(bat_1[i], bat_2[i], uarg + 'd', t1=t, t2=t,
                                                                    shape_rep=shape_rep)
            menergy, p2, q2, tg2, gamma2 = shapedist.find_shapedist(bat_1[i], bat_2[i], marg + 'd', t1=t, t2=t,
                                                                    shape_rep=shape_rep)
            time1 = time.time()
            ...
            time3 = time.time()
            renergy, p3, q3, tg3, gamma3 = shapedist.find_shapedist(bat_1[i], bat_2[i], '' + 'd', t1=t, t2=t, shape_rep=shape_rep)
            time3 = time.time() - time3
            figure_plot(p3, q3, tg3, gamma3, shape_rep, names[i], "NonUniform_Red")
